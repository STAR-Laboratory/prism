...
class DDR5PRAC : public IDRAM, public Implementation {
  RAMULATOR_REGISTER_IMPLEMENTATION(IDRAM, DDR5PRAC, "DDR5-PRAC", "DDR5 with PRAC")
  private:
    int m_RH_radius = -1;
  ...
  public:
    ...
    inline static const std::map<std::string, std::vector<int>> timing_presets = {
      //   name         rate   nBL  nCL nRCD   nRP  nRAS   nRC   nWR  nRTP nCWL nPPD nCCDS nCCDS_WR nCCDS_WTR nCCDL nCCDL_WR nCCDL_WTR nRRDS nRRDL nFAW nRFC1 nRFC2 nRFCsb nREFI nREFSBRD nRFM1 nRFM2 nRFMsb nRFMpb nDRFMab nDRFMsb nVRR nCS, tCK_ps
      {"DDR5_3200AN",  {3200,   8,  24,  24,   24,   52,   75,   48,   12,  22,  2,    8,     8,     22+8+4,    8,     16,    22+8+16,   8,   -1,   -1,  -1,   -1,   -1,    -1,     30,    -1,   -1,   -1,     -1,    -1,     -1,    -1,  2,   625}},
      {"DDR5_3200BN",  {3200,   8,  26,  26,   26,   52,   77,   48,   12,  24,  2,    8,     8,     24+8+4,    8,     16,    24+8+16,   8,   -1,   -1,  -1,   -1,   -1,    -1,     30,    -1,   -1,   -1,     -1,    -1,     -1,    -1,  2,   625}},
      {"DDR5_3200C",   {3200,   8,  28,  28,   28,   52,   79,   48,   12,  26,  2,    8,     8,     26+8+4,    8,     16,    26+8+16,   8,   -1,   -1,  -1,   -1,   -1,    -1,     30,    -1,   -1,   -1,     -1,    -1,     -1,    -1,  2,   625}},
      {"DDR5_4800B",   {4800,   8,  40,  39,   39,   77,   116,  72,   18,  38,  2,    8,     8,         52,   12,     48,    38+8+16,   8,   -1,   -1,  -1,   -1,   -1,    -1,     72,    -1,   -1,   -1,     -1,    -1,     -1,    -1,  2,   416}},
      {"DDR5_6400B",   {6400,   8,  52,  52,   52,   103,  155,  96,   24,  50,  2,    8,     8,         66,   16,     64,    50+8+16,   8,   -1,   -1,  -1,   -1,   -1,    -1,     96,    -1,   -1,   -1,     -1,    -1,     -1,    -1,  2,   312}},
      {"DDR5_8000B",   {8000,   8,  64,  64,   64,   128,  192, 120,   30,  62,  2,    8,     8,         78,   20,     80,    62+8+16,   8,   -1,   -1,  -1,   -1,   -1,    -1,    120,    -1,   -1,   -1,     -1,    -1,     -1,    -1,  2,   250}},
      {"DDR5_8800B",   {8800,   8,  72,  71,   71,   141,  212, 132,   33,  70,  2,    8,     8,         87,   22,     88,    70+8+16,   8,   -1,   -1,  -1,   -1,   -1,    -1,    132,    -1,   -1,   -1,     -1,    -1,     -1,    -1,  2,   227}},
      {"DDR5_12800B", {12800,   8, 103, 103,  103,   205,  308, 192,   48, 101,  2,    8,     8,        122,   32,    128,   101+8+16,   8,   -1,   -1,  -1,   -1,   -1,    -1,    192,    -1,   -1,   -1,     -1,    -1,     -1,    -1,  2,   156}},
      {"DDR5_17600B", {17600,   8, 140, 140,  140,   281,  421, 263,   66, 138,  2,    8,     8,        164,   44,    175,   138+8+16,   8,   -1,   -1,  -1,   -1,   -1,    -1,    263,    -1,   -1,   -1,     -1,    -1,     -1,    -1,  2,   114}},
    };
    ...
    inline static const std::map<std::string, std::vector<double>> current_presets = {
      ...
      {"DDR5_Base",     {103,  92,     81,     377,    349,    277,     8,    6,     7,     9,    37,     28}},
    };
  /************************************************
   *                Organization
   ***********************************************/   
   ...
   ***********************************************/
    inline static constexpr ImplDef m_commands = {
      ...
      "RFMab",  "RFMsb", "RFMpb", "RFMab_end", "RFMsb_end", "RFMpb_end",
    ...
    inline static const ImplLUT m_command_scopes = LUT (
      m_commands, m_levels, {
        ...
        {"RFMab",  "rank"},  {"RFMsb",  "bank"}, {"RFMpb",  "bank"}, {"RFMab_end",  "rank"},  {"RFMsb_end",  "bank"}, {"RFMpb_end",  "bank"},
    ...
    inline static const ImplLUT m_command_meta = LUT<DRAMCommandMeta> (
      m_commands, {
        ...
        {"RFMpb_end",   {false,  true,    false,   false}},
    ...
    inline static constexpr ImplDef m_requests = {
      ...
      "rfm", "same-bank-rfm", "per-bank-rfm",
    ...
    inline static const ImplLUT m_request_translations = LUT (
      m_requests, m_commands, {
        ...
        {"rfm", "RFMab"}, {"same-bank-rfm", "RFMsb"}, {"per-bank-rfm", "RFMpb"},
...
/************************************************
  ...
  public:
    struct Node : public DRAMNodeBase<DDR5PRAC> {
      Node(DDR5PRAC* dram, Node* parent, int level, int id) : DRAMNodeBase<DDR5PRAC>(dram, parent, level, id) {};
    };
    ...
    void check_future_action(int command, const AddrVec_t& addr_vec) {
      switch (command) {
        ...
        case m_commands("RFMsb"):
          ...
          break;
        case m_commands("RFMpb"):
          m_future_actions.push_back({command, addr_vec, m_clk + m_timing_vals("nRFMpb") - 1});
          break;
    ...
    void handle_future_action(int command, const AddrVec_t& addr_vec) {
      ...
      switch (command) {
        ...
        case m_commands("RFMsb"):
          ...
          break;
        case m_commands("RFMpb"):
          m_channels[channel_id]->update_powers(m_commands("RFMpb_end"), addr_vec, m_clk);
          m_channels[channel_id]->update_states(m_commands("RFMpb_end"), addr_vec, m_clk);
          break;
        case m_commands("DRFMab"):
  ...
  private:
    ...
    void set_timing_vals() {
      ...
      //TODO: Update x4 values
      constexpr int nRRDL_TABLE[3][7] = {
      // 3200  4800  6400  8000  8800  12800  17600
        { 5,    12,   16,   16,   18,   26,    35},  // x4
        { 5,    12,   16,   16,   18,   26,    35},  // x8
        { 5,    12,   16,   16,   18,   26,    35},  // x16
      };
      constexpr int nFAW_TABLE[3][7] = {
      // 3200  4800  6400  8000  8800  12800  17600
        { 40,   40,   40,   40,   40,    40,   40},  // x4
        { 32,   32,   32,   32,   32,    32,   32},  // x8
        { 32,   32,   32,   32,   32,    32,   32},  // x16
      };
      ...
      constexpr int nCCD_L_WR2_TABLE[5] = {
      // 3200  6400  8800 12800   17600  
          16,   32,   44,   64,     88
      };
      if (dq_id == 0) {
      ...
      m_timing_vals("nRFMpb") =  m_timing_vals("nRFCsb"); // Conservatively assuming same overhead as RFMsb
      ...
      constexpr int tRRFsb_TABLE[3][3] = {
      //  8Gb 16Gb 32Gb  
        { 70,  70,  70 }, // tRRFab
        { 60,  60,  60 }, // tRRFsb
        { 50,  50,  50 }, // tRRFpb (Expected)
      };
      ...
      auto use_prism = param<bool>("PrISM").default_val(false);
      if (use_prism){
        std::cout << "[Ramulator::DDR5-PRAC] <PrISM> RFMab Timing is updated. " << std::endl;
        m_timing_vals("nRFM1") = (int) ((2 * m_BRC + 1) * JEDEC_rounding_DDR5(tRRFsb_TABLE[0][density_id], tCK_ps));
      }

      auto use_jedec_rfm_timing = param<bool>("PRAC_RFM_Timing").default_val(false);
      if (use_jedec_rfm_timing) {
        std::cout << "[Ramulator::DDR5-PRAC] <RFM TIMING FROM JEDEC PRAC SPEC> RFMab & RFMsb Timing is updated. " << std::endl;
        m_timing_vals("nRFM1") = (int) ((2 * m_BRC + 1) * JEDEC_rounding_DDR5(tRRFsb_TABLE[0][density_id], tCK_ps));
        m_timing_vals("nRFMsb") =(int) ((2 * m_BRC + 1) * JEDEC_rounding_DDR5(tRRFsb_TABLE[1][density_id], tCK_ps));
      }
      ...
      if (prac_enabled) {
        std::cout << "[Ramulator::DDR5-PRAC] <PRAC ENABLED> Timings are updated automatically. " << std::endl;
        // Table 343 JEDEC 79-5C_v1.30
        m_timing_vals("nRAS") = (int) JEDEC_rounding_DDR5(16, tCK_ps);
        m_timing_vals("nRP") = (int) JEDEC_rounding_DDR5(36, tCK_ps);
        m_timing_vals("nRC") = (int) JEDEC_rounding_DDR5(52, tCK_ps);
        m_timing_vals("nRTP") = (int) JEDEC_rounding_DDR5(5, tCK_ps);
        m_timing_vals("nWR") = (int) JEDEC_rounding_DDR5(10, tCK_ps);

        // Table 347
        m_timing_vals("nRFM1") = (int) ((2 * m_BRC + 1) * JEDEC_rounding_DDR5(tRRFsb_TABLE[0][density_id], tCK_ps));
        m_timing_vals("nRFMsb") =(int) ((2 * m_BRC + 1) * JEDEC_rounding_DDR5(tRRFsb_TABLE[1][density_id], tCK_ps));
        m_timing_vals("nRFMpb") =(int) ((2 * m_BRC + 1) * JEDEC_rounding_DDR5(tRRFsb_TABLE[2][density_id], tCK_ps));
    
      }
      auto prac_without_timing_overhead = param<bool>("PRACIdeal").default_val(false);
      if (prac_without_timing_overhead){
        // Table 347
        m_timing_vals("nRFM1") = (int) ((2 * m_BRC + 1) * JEDEC_rounding_DDR5(tRRFsb_TABLE[0][density_id], tCK_ps));
        m_timing_vals("nRFMsb") =(int) ((2 * m_BRC + 1) * JEDEC_rounding_DDR5(tRRFsb_TABLE[1][density_id], tCK_ps));
        m_timing_vals("nRFMpb") =(int) ((2 * m_BRC + 1) * JEDEC_rounding_DDR5(tRRFsb_TABLE[2][density_id], tCK_ps));
      ...
      std::cout << "--------------------------- RH Timing Parameters -----------------------------" <<std::endl;
      std::cout << "[Ramulator::DDR5-PRAC] nRFMab: " << m_timing_vals("nRFM1") << std::endl;
      std::cout << "[Ramulator::DDR5-PRAC] nRFMsb: " << m_timing_vals("nRFMsb") << std::endl;
      std::cout << "[Ramulator::DDR5-PRAC] nRFMpb: " << m_timing_vals("nRFMpb") << std::endl;
      std::cout << "[Ramulator::DDR5-PRAC] nVRR: " << m_timing_vals("nVRR") << std::endl;
      std::cout << "--------------------------- Core Timing Parameters -----------------------------" <<std::endl;
      std::cout << "[Ramulator::DDR5-PRAC] nRAS: " << m_timing_vals("nRAS") << std::endl;
      std::cout << "[Ramulator::DDR5-PRAC] nRP: " << m_timing_vals("nRP") << std::endl;
      std::cout << "[Ramulator::DDR5-PRAC] nRC: " << m_timing_vals("nRC") << std::endl;
      std::cout << "[Ramulator::DDR5-PRAC] nRTP: " << m_timing_vals("nRTP") << std::endl;
      std::cout << "[Ramulator::DDR5-PRAC] nWR: " << m_timing_vals("nWR") << std::endl;
      ...
      populate_timingcons(this, {
          ...
          {.level = "rank", .preceding = {"RFMpb"}, .following = {"PREA"}, .latency = V("nRFMpb")},          
          {.level = "rank", .preceding = {"PREA"}, .following = {"ACT", "VRR", "RFMpb"}, .latency = V("nRP")},          
          /// RAS <-> REF
          ...
          {.level = "rank", .preceding = {"RFMpb"}, .following = {"REFab", "RFMab", "DRFMab"}, .latency = V("nRFMpb")},          
          ...
          {.level = "rank", .preceding = {"REFab"}, .following = {"ACT", "VRR", "PREA", "REFab", "RFMab", "DRFMab", "REFsb", "RFMsb", "RFMpb", "DRFMsb"}, .latency = V("nRFC1")},          
          {.level = "rank", .preceding = {"RFMab"}, .following = {"ACT", "VRR", "PREA", "REFab", "RFMab", "DRFMab", "REFsb", "RFMsb", "RFMpb", "DRFMsb"}, .latency = V("nRFM1")},          
          {.level = "rank", .preceding = {"DRFMab"}, .following = {"ACT", "VRR", "RFMpb", "PREA", "REFab", "RFMab", "DRFMab", "REFsb", "RFMsb", "DRFMsb"}, .latency = V("nDRFMab")},          
          ...
          /*** Bank ***/ 
          {.level = "bank", .preceding = {"ACT"}, .following = {"ACT", "VRR", "REFsb", "RFMsb",   "RFMpb", "DRFMsb"}, .latency = V("nRC")},  
          {.level = "bank", .preceding = {"VRR"}, .following = {"ACT", "VRR", "REFsb", "RFMsb",  "RFMpb", "DRFMsb"}, .latency = V("nVRR")},  
          {.level = "bank", .preceding = {"RFMpb"}, .following = {"ACT", "VRR", "REFsb", "RFMsb",  "RFMpb", "DRFMsb"}, .latency = V("nVRR")},  
          ...
          {.level = "bank", .preceding = {"PRE", "PREsb"}, .following = {"ACT", "VRR", "REFsb", "RFMsb", "RFMpb", "DRFMsb"}, .latency = V("nRP")},  
          ...
          {.level = "bank", .preceding = {"RDA"}, .following = {"ACT", "VRR", "REFsb", "RFMsb",  "RFMpb", "DRFMsb"}, .latency = V("nRTP") + V("nRP")},  
          {.level = "bank", .preceding = {"WRA"}, .following = {"ACT", "VRR", "REFsb", "RFMsb",  "RFMpb", "DRFMsb"}, .latency = V("nCWL") + V("nBL") + V("nWR") + V("nRP")},  
          ...
          {.level = "bank", .preceding = {"REFsb"},  .following = {"ACT", "VRR", "REFsb", "RFMsb", "RFMpb", "DRFMsb"}, .latency = V("nRFCsb")},  
          {.level = "bank", .preceding = {"RFMsb"},  .following = {"ACT", "VRR", "REFsb", "RFMsb", "RFMpb", "DRFMsb"}, .latency = V("nRFMsb")},  
          {.level = "bank", .preceding = {"DRFMsb"}, .following = {"ACT", "VRR", "REFsb", "RFMsb", "RFMpb", "DRFMsb"}, .latency = V("nDRFMsb")},  
        }
      );
      #undef V
    ...
    void set_actions() {
      ...
      // Rank Actions
      m_actions[m_levels["rank"]][m_commands["PREA"]] = Lambdas::Action::Rank::PREab<DDR5PRAC>;
      m_actions[m_levels["rank"]][m_commands["REFab"]] = Lambdas::Action::Rank::REFab<DDR5PRAC>;
      m_actions[m_levels["rank"]][m_commands["REFab_end"]] = Lambdas::Action::Rank::REFab_end<DDR5PRAC>;
      m_actions[m_levels["rank"]][m_commands["RFMab"]] = Lambdas::Action::Rank::REFab<DDR5PRAC>;
      m_actions[m_levels["rank"]][m_commands["RFMab_end"]] = Lambdas::Action::Rank::REFab_end<DDR5PRAC>;
      m_actions[m_levels["rank"]][m_commands["DRFMab"]] = Lambdas::Action::Rank::REFab<DDR5PRAC>;
      m_actions[m_levels["rank"]][m_commands["DRFMab_end"]] = Lambdas::Action::Rank::REFab_end<DDR5PRAC>;

      // Same-Bank Actions.
      m_actions[m_levels["bankgroup"]][m_commands["PREsb"]] = Lambdas::Action::BankGroup::PREsb<DDR5PRAC>;

      // We call update_timing for the banks in other BGs here
      m_actions[m_levels["bankgroup"]][m_commands["REFsb"]]  = Lambdas::Action::BankGroup::REFsb<DDR5PRAC>;
      m_actions[m_levels["bankgroup"]][m_commands["REFsb_end"]]  = Lambdas::Action::BankGroup::REFsb_end<DDR5PRAC>;
      m_actions[m_levels["bankgroup"]][m_commands["RFMsb"]]  = Lambdas::Action::BankGroup::REFsb<DDR5PRAC>;
      m_actions[m_levels["bankgroup"]][m_commands["RFMsb_end"]]  = Lambdas::Action::BankGroup::REFsb_end<DDR5PRAC>;
      m_actions[m_levels["bankgroup"]][m_commands["DRFMsb"]] = Lambdas::Action::BankGroup::REFsb<DDR5PRAC>;
      m_actions[m_levels["bankgroup"]][m_commands["DRFMsb_end"]] = Lambdas::Action::BankGroup::REFsb_end<DDR5PRAC>;

      // Bank actions
      m_actions[m_levels["bank"]][m_commands["ACT"]] = Lambdas::Action::Bank::ACT<DDR5PRAC>;
      m_actions[m_levels["bank"]][m_commands["PRE"]] = Lambdas::Action::Bank::PRE<DDR5PRAC>;
      m_actions[m_levels["bank"]][m_commands["RDA"]] = Lambdas::Action::Bank::PRE<DDR5PRAC>;
      m_actions[m_levels["bank"]][m_commands["WRA"]] = Lambdas::Action::Bank::PRE<DDR5PRAC>;
      m_actions[m_levels["bank"]][m_commands["VRR"]] = Lambdas::Action::Bank::VRR<DDR5PRAC>;
      m_actions[m_levels["bank"]][m_commands["VRR_end"]] = Lambdas::Action::Bank::VRR_end<DDR5PRAC>;
      m_actions[m_levels["bank"]][m_commands["RFMpb"]] = Lambdas::Action::Bank::RFMpb<DDR5PRAC>;
      m_actions[m_levels["bank"]][m_commands["RFMpb_end"]] = Lambdas::Action::Bank::RFMpb_end<DDR5PRAC>;
    ...
    void set_preqs() {
      ...
      // Rank Preqs
      m_preqs[m_levels["rank"]][m_commands["REFab"]]  = Lambdas::Preq::Rank::RequireAllBanksClosed<DDR5PRAC>;
      m_preqs[m_levels["rank"]][m_commands["RFMab"]]  = Lambdas::Preq::Rank::RequireAllBanksClosed<DDR5PRAC>;
      m_preqs[m_levels["rank"]][m_commands["DRFMab"]] = Lambdas::Preq::Rank::RequireAllBanksClosed<DDR5PRAC>;
      m_preqs[m_levels["rank"]][m_commands["PREA"]] = Lambdas::Preq::Rank::RequireAllBanksClosed<DDR5PRAC>;

      // Same-Bank Preqs.
      m_preqs[m_levels["rank"]][m_commands["REFsb"]]  = Lambdas::Preq::Rank::RequireSameBanksClosed<DDR5PRAC>;
      m_preqs[m_levels["rank"]][m_commands["RFMsb"]]  = Lambdas::Preq::Rank::RequireSameBanksClosed<DDR5PRAC>;
      m_preqs[m_levels["rank"]][m_commands["DRFMsb"]] = Lambdas::Preq::Rank::RequireSameBanksClosed<DDR5PRAC>;

      // Bank Preqs
      m_preqs[m_levels["bank"]][m_commands["RD"]] = Lambdas::Preq::Bank::RequireRowOpen<DDR5PRAC>;
      m_preqs[m_levels["bank"]][m_commands["WR"]] = Lambdas::Preq::Bank::RequireRowOpen<DDR5PRAC>;
      m_preqs[m_levels["bank"]][m_commands["VRR"]] = Lambdas::Preq::Bank::RequireBankClosed<DDR5PRAC>;
      m_preqs[m_levels["bank"]][m_commands["RFMpb"]] = Lambdas::Preq::Bank::RequireBankClosed<DDR5PRAC>;
      m_preqs[m_levels["bank"]][m_commands["ACT"]] = Lambdas::Preq::Bank::RequireRowOpen<DDR5PRAC>;
      m_preqs[m_levels["bank"]][m_commands["PRE"]] = Lambdas::Preq::Bank::RequireBankClosed<DDR5PRAC>;
    ...
    void set_rowhits() {
      ...
      m_rowhits[m_levels["bank"]][m_commands["RD"]] = Lambdas::RowHit::Bank::RDWR<DDR5PRAC>;
      m_rowhits[m_levels["bank"]][m_commands["WR"]] = Lambdas::RowHit::Bank::RDWR<DDR5PRAC>;
    }
    ...
    void set_rowopens() {
      ...
      m_rowopens[m_levels["bank"]][m_commands["RD"]] = Lambdas::RowOpen::Bank::RDWR<DDR5PRAC>;
      m_rowopens[m_levels["bank"]][m_commands["WR"]] = Lambdas::RowOpen::Bank::RDWR<DDR5PRAC>;
    }
    ...
    void set_powers() {
      ...
      m_powers[m_levels["bank"]][m_commands["ACT"]] = Lambdas::Power::Bank::ACT<DDR5PRAC>;
      m_powers[m_levels["bank"]][m_commands["PRE"]] = Lambdas::Power::Bank::PRE<DDR5PRAC>;
      m_powers[m_levels["bank"]][m_commands["RD"]]  = Lambdas::Power::Bank::RD<DDR5PRAC>;
      m_powers[m_levels["bank"]][m_commands["WR"]]  = Lambdas::Power::Bank::WR<DDR5PRAC>;
      m_powers[m_levels["bank"]][m_commands["VRR"]]  = Lambdas::Power::Bank::VRR<DDR5PRAC>;
      m_powers[m_levels["bank"]][m_commands["RFMpb"]]  = Lambdas::Power::Bank::RFMpb<DDR5PRAC>;

      // m_powers[m_levels["rank"]][m_commands["REFsb"]] = Lambdas::Power::Rank::REFsb<DDR5PRAC>;
      // m_powers[m_levels["rank"]][m_commands["REFsb_end"]] = Lambdas::Power::Rank::REFsb_end<DDR5PRAC>;
      m_powers[m_levels["rank"]][m_commands["RFMsb"]] = Lambdas::Power::Rank::RFMsb<DDR5PRAC>;
      m_powers[m_levels["rank"]][m_commands["RFMsb_end"]] = Lambdas::Power::Rank::RFMsb_end<DDR5PRAC>;
      // m_powers[m_levels["rank"]][m_commands["DRFMsb"]] = Lambdas::Power::Rank::REFsb<DDR5PRAC>;
      // m_powers[m_levels["rank"]][m_commands["DRFMsb_end"]] = Lambdas::Power::Rank::REFsb_end<DDR5PRAC>;

      m_powers[m_levels["rank"]][m_commands["ACT"]] = Lambdas::Power::Rank::ACT<DDR5PRAC>;
      m_powers[m_levels["rank"]][m_commands["PRE"]] = Lambdas::Power::Rank::PRE<DDR5PRAC>;
      m_powers[m_levels["rank"]][m_commands["PREA"]] = Lambdas::Power::Rank::PREA<DDR5PRAC>;
      m_powers[m_levels["rank"]][m_commands["REFab"]] = Lambdas::Power::Rank::REFab<DDR5PRAC>;
      m_powers[m_levels["rank"]][m_commands["REFab_end"]] = Lambdas::Power::Rank::REFab_end<DDR5PRAC>;
      // m_powers[m_levels["rank"]][m_commands["RFMab"]] = Lambdas::Power::Rank::REFab<DDR5PRAC>;
      // m_powers[m_levels["rank"]][m_commands["RFMab_end"]] = Lambdas::Power::Rank::REFab_end<DDR5PRAC>;
      // m_powers[m_levels["rank"]][m_commands["DRFMab"]] = Lambdas::Power::Rank::REFab<DDR5PRAC>;
      // m_powers[m_levels["rank"]][m_commands["DRFMab_end"]] = Lambdas::Power::Rank::REFab_end<DDR5PRAC>;
      m_powers[m_levels["rank"]][m_commands["VRR"]] = Lambdas::Power::Rank::VRR<DDR5PRAC>;
      m_powers[m_levels["rank"]][m_commands["VRR_end"]] = Lambdas::Power::Rank::VRR_end<DDR5PRAC>;

      m_powers[m_levels["rank"]][m_commands["RFMpb"]] = Lambdas::Power::Rank::RFMpb<DDR5PRAC>;
      m_powers[m_levels["rank"]][m_commands["RFMpb_end"]] = Lambdas::Power::Rank::RFMpb_end<DDR5PRAC>;

      m_powers[m_levels["rank"]][m_commands["PREsb"]] = Lambdas::Power::Rank::PREsb<DDR5PRAC>;
    ...
    void process_rank_energy(PowerStats& rank_stats, Node* rank_node) {
      ...
      Lambdas::Power::Rank::finalize_rank<DDR5PRAC>(rank_node, 0, AddrVec_t(), m_clk);
      ...
      double ref_cmd_energy  = (VE("VDD") * (CE("IDD5B") - CE("IDD3N")) + VE("VPP") * (CE("IPP5B") - CE("IPP3N"))) 
