#!/bin/bash
# ----------------------------------------------------------------------
# PrISM -- Run Figure 9 experiments (TRR rate sensitivity at TRH-D = 500)
#
# This script:
...
echo "[INFO] Generating Ramulator2 configurations and SLURM job scripts (Fig. 9)"
