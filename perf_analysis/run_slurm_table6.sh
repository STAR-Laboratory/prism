#!/bin/bash
# ----------------------------------------------------------------------
# PrISM -- Run Table VI experiments (PMQ size sensitivity at TRH-D = 500)
#
# This script:
...
echo "[INFO] Generating Ramulator2 configurations and SLURM job scripts (Table VI)"
